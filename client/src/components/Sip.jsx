...
//   return (
//     <div>
//       <div className=" text-lg:text-3xl text-2xl font-extrabold pb-2 dark:text-white text-black border-solid border-b-2 m-4 ">
//       Systematic Investment Plan
//       <select className='ml-10' value={selectedComponent} onChange={handleChange}>
...
//       </select>
//       </div>
//       {selectedComponent === 'sipcalc' && <Sipcalc lumpsum={lumpsum}
//       principal={principal}
...
//       setTenure={setTenure}/>}
//       {selectedComponent === 'sipreport' && <Sipreport
//       yeararr={yeararr} //1
//       tinvestedarr={tinvestedarr} //2
//       tyearlyi={tyearlyi} //3
//       returnsEarned={yearlymat}
//       yearend={yearend}/>}
//       {selectedComponent === 'sipgraph' && <Sipgraph
//       yeararr={yeararr} //1
//       tinvestedarr={tinvestedarr} //2
//       tyearlyi={tyearlyi} //3
//       returnsEarned={yearlymat}/>}
...
//     <div className='mb-10 relative flex flex-row p-3'>
//     <form onSubmit={(e) => e.preventDefault()}>
//     <div className='flex flex-row p-3'>
//       <p className="w-3/4 md:text-xl text-base m-auto -ml-0 block  mr-0 font-extrabold tarcking-tight dark:text-white text-black">
//         Amount already added:
//       </p>
//       <input className="w-1/3 h-8 mx-auto  text-center border-1 border-solid border-black rounded-md" type='number' id="lumpsum" placeholder='Lumpsum amt' value={props.lumpsum} onInput={(e) => props.setLumpSum(e.target.value)} />
//       <br />
//       <br />
...
//         Principal Amount:
//       </p>
//       <input className="w-1/3 h-8 mx-auto  text-center border-1 border-solid border-black rounded-md" type='number' id="principal" placeholder='principal amt' value={props.principal} onInput={(e) => props.setPrincipal(e.target.value)} />
//       <br />
//       <br />
...
//         Interest Rate:
//       </p>
//       <input className="w-1/3 h-8 mx-auto  text-center border-1 border-solid border-black rounded-md" type='number' id="interestRate" placeholder='Interest Rate' value={props.interestRate} onInput={(e) => props.setInterestRate(e.target.value)} />
//       <br />
//       <br />
...
//         Tenure (in years):
//       </p>
//       <input className="w-1/3 h-8 mx-auto  text-center border-1 border-solid border-black rounded-md" type='number' id="tenure" placeholder='Tenure' value={props.tenure} onInput={(e) => props.setTenure(e.target.value)} />
//       <br />
//       <br />

//     </div>

//     <p className='dark:text-white text-black font-bold p-2 items-center'>Maturity Value: {props.maturityValue}</p>
//     <br />
//     <br />
//     <button style={{ background: props.currentColor}} className="flex gap-2 p-2 px-7 text-xl mb-5 rounded-md text-white"onClick={props.calculateMaturityValue}>
//        Calculate
//     </button>
//   </form>
//     </div>
...
//     <div className='md:m-10 mb-10 mt-24 md:mx-9 mx-2 p-2 md:p-6 dark:bg-secondary-dark-bg rounded-3xl flex flex-col lg:flex-col lg:items-center'>
//     <div className='mb-10 relative flex flex-row'>
//     <ChartComponent title="SIP Growth Chart" legendSettings={{ visible: true }}>
//       <Inject services={[LineSeries,Tooltip]}></Inject>
//       <SeriesCollectionDirective>
//         <SeriesDirective type='Line' dataSource={data}
//         xName='year' yName='invested' name='Invested Amount'>
//         </SeriesDirective>
//         <SeriesDirective type='line' dataSource={data} xName='year' yName='maturity' name='Maturity Value'>
//         </SeriesDirective>
//         <SeriesDirective type='line' dataSource={data} xName='year' yName='returns' name='Maturity Value'>
//         </SeriesDirective>
//       </SeriesCollectionDirective>
//     </ChartComponent>
//     </div>
...
//             <div className='flex flex-row text-white justify-between cursor-pointer text-lg ' onClick={() => toggle(i)}>
//               {item.question}
//               <br/><br/>
...
//               </span>
//             </div>
//             <div className={`text-white h-auto transition-all duration-500 ${selected === i ? "max-h-screen" : "max-h-0 overflow-hidden"}`}>
//             {item.answer}
//             </div>
//           </div>
//           </div>
